		...
		<div className="matchSchedule-match">
			<div className="row">
				<div className="col-sm">
					<span className="matchSchedule-match-time">{moment(new Date(props.match.date)).format('HH:mm')}</span>
				</div>
				<div className="col-sm">
					<span className="matchSchedule-match-flag">{props.homeTeamEmoji}</span>
					<span className="matchSchedule-match-name">{props.homeTeam}</span>
					<br/>
					<span className="matchSchedule-match-flag">{props.awayTeamEmoji}</span>
